...
class Config:
    def __init__(self):
        ...
        self.SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/jasminemusicgc")
        self.SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/jasminemusicgc")
        ...
        # ---------------------------------------------------------
        try:
            self.AUDIO_CACHE_CHANNEL = int(getenv("AUDIO_CACHE_CHANNEL", "-1004068406600"))
        except ValueError:
            self.AUDIO_CACHE_CHANNEL = None

        try:
            self.VIDEO_CACHE_CHANNEL = int(getenv("VIDEO_CACHE_CHANNEL", "-1003765204368"))
        except ValueError:
            self.VIDEO_CACHE_CHANNEL = None
        # ---------------------------------------------------------
